...
[R packages](https://r-pkgs.org/) d'Hadley Wickham.
...
On récupère la structure **minimale pour un package R**, à savoir :
  ...
  - un dossier `r fontawesome::fa("r-project")` dans lequel on va ajouter des fichiers de scripts R
...
dans le dossier `r fontawesome::fa("r-project")` du package, qui :
...
[R code](https://r-pkgs.org/r.html) du site d'Hadley.
...
sur "Configure" puis cocher la case en bas "Install and Restart".
...
## Annexe 1.3 : construire un site web pour accompagner son package
