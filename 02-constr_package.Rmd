...
On récupère alors la structure **minimale pour un package `r fontawesome::fa("r-project")`**, à savoir :
  ...
  - un dossier **R** dans lequel on va ajouter des fichiers de scripts `r fontawesome::fa("r-project")`
...
sur les $n$ points $\boldsymbol \mathbf{x}$ en un seul appel de la fonction.
